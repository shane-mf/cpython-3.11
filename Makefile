...
abs_srcdir=	/Users/lvsheng/work/cpython-3.11
abs_builddir=	/Users/lvsheng/work/cpython-3.11
...
SHLIB_SUFFIX=	.so
EXT_SUFFIX=	.cpython-311d-darwin.so
...
MODULE__DECIMAL_CFLAGS=-I$(srcdir)/Modules/_decimal/libmpdec -DTEST_COVERAGE -DUNIVERSAL=1
MODULE__DECIMAL_LDFLAGS=-lm $(LIBMPDEC_A)
MODULE__GDBM_STATE=yes
MODULE__GDBM_CFLAGS=-I/opt/homebrew/opt/gdbm/include
MODULE__GDBM_LDFLAGS=-L/opt/homebrew/opt/gdbm/lib -lgdbm
...
CONFIG_ARGS=	 '--with-pydebug' '--with-openssl=/opt/homebrew/opt/openssl@3' 'GDBM_CFLAGS=-I/opt/homebrew/opt/gdbm/include' 'GDBM_LIBS=-L/opt/homebrew/opt/gdbm/lib -lgdbm'
...
LIBMPDEC_CFLAGS=-I$(srcdir)/Modules/_decimal/libmpdec -DTEST_COVERAGE -DUNIVERSAL=1 $(PY_STDMODULE_CFLAGS) $(CCSHARED)

# for setup.py
DECIMAL_CFLAGS=-I$(srcdir)/Modules/_decimal/libmpdec -DTEST_COVERAGE -DUNIVERSAL=1
...
# This goes into $(exec_prefix)
LIBPL=		$(prefix)/lib/python3.11/config-$(VERSION)$(ABIFLAGS)-darwin
